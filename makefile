...
data/data.csv: download_ssrs.py
	@python3 download_ssrs.py /Student+Life/Retention+Analysis=data/data.csv /Housing+\(managed\)/tables/people=data/people.csv /Housing+\(managed\)/tables/address=data/address.csv
